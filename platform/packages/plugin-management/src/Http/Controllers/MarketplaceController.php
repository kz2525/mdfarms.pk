...
class MarketplaceController extends Controller
{
    ...
    public function update(string $id, MarketplaceService $marketplaceService, PluginService $pluginService): JsonResponse
    {
        $detail = $this->detail($id, $marketplaceService);
        ...
        $pluginService->runMigrations($name);

        $published = $pluginService->publishAssets($name);
        ...
        $pluginService->publishTranslations($name);
