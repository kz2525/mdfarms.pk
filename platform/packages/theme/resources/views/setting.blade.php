    ...
    <div class="flexbox-annotated-section-content">
        <div class="wrapper-content pd-all-20">
            ...
            <div class="form-group">
                <label class="text-title-field" for="show_theme_guideline_link">{{ trans('packages/theme::theme.settings.show_guidelines') }}</label>
                <label class="me-2">
                    <input type="radio" name="show_theme_guideline_link" value="1" @checked(setting('show_theme_guideline_link', false)) class="setting-selection-option">
                    {{ trans('core/setting::setting.general.yes') }}
                </label>
                <label>
                    <input type="radio" name="show_theme_guideline_link" value="0" @checked(! setting('show_theme_guideline_link', false)) class="setting-selection-option">
                    {{ trans('core/setting::setting.general.no') }}
                </label>
            </div>
        </div>
