<template>
    <div class="flexbox-grid no-pd-none">
                                        ...
                                        <ul class="clearfix" v-show="!loading">
                                            <li v-for="product_item in list_products.data"
                                                ...
                                                <div class="inline_block ml10 mt10 ws-nm" style="width: calc(100% - 50px);">
                                                    <ProductAction :ref="'product_actions_' + product_item.id" :product="product_item" @select-product="selectProductVariant"></ProductAction>
                                                </div>
        ...
        <b-modal id="add-shipping" :title="__('order.shipping_fee')" :ok-title="__('order.update')" :cancel-title="__('order.close')"
            ...
            <div class="next-form-section">
                <div class="ui-layout__item mb15 p-none-important" v-if="!child_products.length || !child_customer_address.phone">
                    ...
                    <div class="next-form-grid">
                        <div class="next-form-grid-cell">
                            <label class="next-label">
                                ...
                                <span class="small text-warning" v-if="shipping_methods && ! Object.keys(shipping_methods).length">{{ __('order.shipping_method_not_found') }}</span>
                            </label>
                        </div>
                    </div>
