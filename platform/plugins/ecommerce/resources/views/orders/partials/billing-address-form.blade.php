        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-12">
                <div class="form-group  @error('billing_address.phone') has-error @enderror">
                    {!! Form::phoneNumber('billing_address[phone]', old('billing_address.phone', Arr::get($sessionCheckoutData, 'billing_address.phone')) ?: (auth('customer')->check() ? auth('customer')->user()->phone : null), ['id' => 'billing-address-phone', 'class' => 'form-control checkout-input checkout-input']) !!}
