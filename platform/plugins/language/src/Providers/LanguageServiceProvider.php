    ...
    public function boot(): void
    {
        ...
        if (! $this->app->runningInConsole() && is_plugin_active('language')) {
            ...
            add_filter('setting_email_template_path', function (string $path, string $module, string $templateKey): string {
                $currentLocale = is_in_admin(true) ? Language::getCurrentAdminLocaleCode() : Language::getCurrentLocaleCode();
                $locale = $currentLocale !== Language::getDefaultLocaleCode() ? $currentLocale : null;
