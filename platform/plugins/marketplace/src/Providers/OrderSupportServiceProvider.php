...
class OrderSupportServiceProvider extends ServiceProvider
{
    ...
    public function processPostCheckoutOrder(array|EloquentCollection $products, Request $request, string $token, array $sessionCheckoutData, BaseHttpResponse $response)
    {
        $groupedProducts = $this->cartGroupByStore($products);
    ...
    public function processShippingDiscountOrderData(array|EloquentCollection $products, string $token, array $sessionCheckoutData, Request $request): array
    {
        $groupedProducts = $this->cartGroupByStore($products);
    ...
    public function handleProcessOrder(EloquentCollection $products, string $token, array $sessionData, Request $request): array
    {
        $groupedProducts = $this->cartGroupByStore($products);
