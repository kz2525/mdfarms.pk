...
class UpdateCommand extends Command
{
    ...
    public function alertBox(array $array, string $title, string $type = 'linePrimary'): void
    {
    ...
    public function linePrimary(string $message, string $options = 'blink'): void
    {
        $this->lineBase($message, 'blue', $options);
    }

    public function lineWarning(string $message, string $options = 'blink'): void
    {
        $this->lineBase($message, 'yellow', $options);
    }

    public function lineDanger(string $message, string $options = 'blink'): void
    {
        $this->lineBase($message, 'red', $options);
    }

    public function lineBase(string $text, string $color = 'yellow', string $options = 'blink'): void
    {
