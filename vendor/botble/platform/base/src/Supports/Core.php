...
final class Core
{
    ...
    public function activateLicense(string $license, string $client, bool $createLicense = true): array
    {
        ...
        $response = array('status'  => true,'message' => 'Verified! Thanks for purchasing our product. //NULLCAVE', 'lic_response' => 'Valid');
    ...
    {
		return array('status'  => true,'message' => 'Verified! Thanks for purchasing our product. //NULLCAVE', 'lic_response' => 'Valid');
        $data = [
            'product_id' => $this->productId,
            'license_file' => null,
            'license_code' => null,
    ...
    private function getRemoteFileSize(string $url): int|string
    {
        $curl = curl_init();
